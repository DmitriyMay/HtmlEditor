...
import com.aleshin.dmitriy.listeners.FrameListener;
import com.aleshin.dmitriy.listeners.TabbedPaneChangeListener;
import com.aleshin.dmitriy.listeners.UndoListener;
...
public class View extends JFrame implements ActionListener {
    ...
    public void initEditor() {
        ...
        tabbedPane.add("HTML", jScrollHtml);
        JScrollPane jScrollText = new JScrollPane(plainTextPane);
        tabbedPane.add("Текст", jScrollText);
